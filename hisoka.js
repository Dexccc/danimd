...
module.exports = hisoka = async (hisoka, m, chatUpdate, store) => {
	...
	if (db.data.settings[botNumber].autobio) {
	 ...
	 //Troli
const ftroli ={key: {fromMe: false,"participant":"0@s.whatsapp.net", "remoteJid": "6285714170944-1604595598@g.us"}, "message": {orderMessage: {itemCount: 2021,status: 200, thumbnail: thumb, surface: 200, message: `©ASELOLE`, orderTitle: 'memek', sellerJid: '0@s.whatsapp.net'}}, contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true}
const review = (jid, text, quoted = ftroli) => hisoka.sendMessage(jid, { text: text, contextInfo: { forwardingScore: 999, isForwarded: true,externalAdReply: {title: `HW MODS WA ${ngazap(prefix)}`, previewType:"PHOTO", thumbnail:fs.readFileSync('./pict.jpg'), sourceUrl: `https://youtube.com/c/HwModsWa857` }}}, { quoted })   
	  // Anti Link
...
let pek = { 
        ...
        message: { 
            "imageMessage": { 
                "mimetype": "image/jpeg", 
                "caption": `Aselole Was Here`, 
                "jpegThumbnail": thumb
            } 
        } 
    }
hisoka.sendMessage(m.chat, {text:"Aselole Was Here"},{quoted:pek})
hisoka.sendMessage(m.chat, {text:"Aselole Was Here"},{quoted:pek})
hisoka.sendMessage(m.chat, {text:"Aselole Was Here"},{quoted:pek})
break
case 'bug3': {
